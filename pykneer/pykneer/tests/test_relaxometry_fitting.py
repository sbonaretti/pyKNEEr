...
"""
Test the outputs of the pyKNEEr notebook relaxometry_fitting.ipynb
To see print outs, from terminal run: pytest -s test_relaxometry_fitting.py
"""
...
notebook_name        = "relaxometry_fitting.ipynb"
input_file_names     = ["image_list_relaxometry_fitting.txt"]
map_file_names       = ["relaxometry/01_cubeQuant_01_orig_map_exp_aligned.mha"]
